...
class Gaps {
  ...
  static Widget line = const SizedBox(
    ...
    child: const DecoratedBox(decoration: BoxDecoration(color: AppColors.line)),
  );
...
//  static Widget line = const Divider();
  ...
  static Widget centerLine = const SizedBox(
    width: 1.0,
    height: 24.0,
    child: DecoratedBox(
  ...
  static sizeBoxWidget(double height,Color color){
    return SizedBox(height: height,child: DecoratedBox(decoration: BoxDecoration(color: color)),);
  }
  static Widget downLine = const SizedBox(
    height: Dimens.font_sp10,
    width: double.infinity,
