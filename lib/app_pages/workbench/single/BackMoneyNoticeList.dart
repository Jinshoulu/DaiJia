...
class BackMoneyNoticeList extends StatefulWidget {
  @override
  _BackMoneyNoticeListState createState() => _BackMoneyNoticeListState();
}

class _BackMoneyNoticeListState extends State<BackMoneyNoticeList> {
