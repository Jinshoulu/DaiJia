...
import 'package:demo/tools/net/md5.dart';
...
//        disabledTextColor: isDark ? AppColors.dark_text : AppColors.whiteColor,
//        disabledColor: isDark ? AppColors.dark_text_gray : AppColors.text_gray_c,
        child: Container(
          ...
          child: Text(
            ...
            style: TextStyle(fontSize: Dimens.font_sp12,color: AppColors.blackColor),
          ),
        ),
      ),
    );
